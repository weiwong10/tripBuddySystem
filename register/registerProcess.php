...
*/
  ...
  if (count($errors) == 0) {
	$password = ($password_1);//enzcrypt the password before saving in the database
  	...
  	$query = "INSERT INTO Users (name , username, gentle, dob, address, contactNo, email, icNo, password) 
  			  VALUES('$name','$username', '$gentle', '$dob', '$address', '$contactNo', '$email', '$icNo', '$password')";
